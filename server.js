...
{"items": [{"name": "название", "grams": число, "calories": число, "protein": число, "fat": число, "carbs": число}], "summary": "строка", "confident": true или false, "note": "краткий комментарий на русском"}
...
Опиши в ней ВСЮ еду из диалога так, как её описал сам человек: обычными словами и его мерами.
В summary НЕ должно быть ни граммов, ни калорий, ни белков, жиров и углеводов — только еда и порции человеческим языком.
Пример: "Я ел три небольших яйца, суп только овощной — средняя тарелка, и два небольших куска хлеба без масла."`;
