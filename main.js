...
Как писать:
- 2–4 предложения, одним абзацем, без списков, заголовков и кавычек;
- настоящее время, как будто всё уже так и есть;
- опирайся на то, что действительно есть в карте: называй её направления и результаты, а не общие слова;
...
- без обращений к читателю, без вступлений вроде «Конечно», без пересказа задания и без обещаний «дальше разберём подробнее».

Текст попадает прямо в окно карты, поэтому в нём не должно быть ни вступления, ни разбора, ни списков, ни разметки вроде звёздочек и решёток.

Если тебе нужно порассуждать, вынеси рассуждение вперёд и отдели его строкой ровно из трёх дефисов: ---
После этой строки — только сам абзац, и ничего больше. Строка из трёх дефисов может встретиться в ответе не более одного раза. Не нужно рассуждения — не ставь её вовсе и дай один абзац.
